// Ce code représente la page de mise à jour d'un espace de coworking dans l'application.
// Il effectue une requête vers une API RESTful pour récupérer les détails d'un espace de coworking spécifique, en utilisant son ID passé dans l'URL.
// Ensuite, il affiche un formulaire pré-rempli avec les détails actuels de l'espace de coworking, permettant à l'utilisateur de les mettre à jour.
// Lorsque le formulaire est soumis, une requête PUT est envoyée à l'API avec les nouvelles valeurs. 
// Si la réponse de l'API est un code 200, cela signifie que la mise à jour s'est bien déroulée, sinon un message d'erreur est affiché dans la console.
// La page utilise également des composants de React Router pour gérer les paramètres d'URL et le composant Header pour afficher un en-tête commun à la page.
